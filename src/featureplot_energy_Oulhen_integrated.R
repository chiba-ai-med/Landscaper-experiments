...
energy_DAPT <- unlist(read.table(paste0('plot/oulhen/DAPT/', pc, '/Landscaper/E.tsv'), header=FALSE))
...
energy_cont <- unlist(read.table(paste0('plot/oulhen/cont/', pc, '/Landscaper/E.tsv'), header=FALSE))
...
energy_integrated <- unlist(read.table(paste0('plot/oulhen/integrated/', pc, '/Landscaper/E.tsv'), header=FALSE))
...
colData(sce)$condition <- seurat.integrated@meta.data$orig.ident
