...
energy_DAPT <- unlist(read.table(paste0('plot/DAPT/', pc, '/Landscaper/E.tsv'), header=FALSE))
...
####################### cont Step ####################
all_states_cont <- unlist(read.delim(paste0('plot/cont/', pc, '/Landscaper/Allstates.tsv'), header=FALSE, sep="|"))
bin_data_cont <- unlist(read.delim(paste0('output/cont/', pc, '/binpca/BIN_DATA.tsv'), header=FALSE, sep="|"))
energy_cont <- unlist(read.table(paste0('plot/cont/', pc, '/Landscaper/E.tsv'), header=FALSE))
...
energy_integrated <- unlist(read.table(paste0('plot/integrated/', pc, '/Landscaper/E.tsv'), header=FALSE))
